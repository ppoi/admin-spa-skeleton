...
<script>
  ...
  import { routeMatched, navigate, registerDOMEventListeners, unregisterDOMEventListeners } from "./core/router";
  import env from './core/env';
  import { onDestroy, onMount } from "svelte";
  import LoadingScreen, { loading } from "./widgets/loading-screen.svelte";
